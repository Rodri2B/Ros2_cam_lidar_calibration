...

{
  ...
  pcl::LeastMedianSquares<pcl::PointXYZ> ransac (model_p);
...

{
  ...
  pcl::LeastMedianSquares<pcl::PointXYZ> ransac (model_s);
...
std::cerr << "Model coefficients: " << model_coefficients[0] << " " 
                                    << model_coefficients[1] << " "
                                    << model_coefficients[2] << " " 
                                    << model_coefficients[3] << ", " << model_coefficients.size() << std::endl;
